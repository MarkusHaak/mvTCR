...
class PoEEmbModelTorch(nn.Module):
    def __init__(self, tcr_params, rna_params, joint_params):
        super(PoEEmbModelTorch, self).__init__()
...
class PoEEmbModel(VAEBaseModel):
    def __init__(self,
                 adata,
                 params_architecture,
        ...
        super(PoEEmbModel, self).__init__(adata, params_architecture, balanced_sampling, metadata,
                                       conditional, optimization_mode_params, label_key, device)

        self.model_type = 'poe_emb'
        ...
        self.model = PoEEmbModelTorch(self.params_tcr, self.params_rna, self.params_joint)
