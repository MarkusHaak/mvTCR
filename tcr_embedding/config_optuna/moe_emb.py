def suggest_params(trial):
    ...
    rna_hidden = trial.suggest_int('rna_hidden', 250, 2000, step=250)  # hdim should be less than rna_hidden
    tcr_hidden = trial.suggest_int('tcr_hidden', 250, 2000, step=250)  # hdim should be less than rna_hidden
    ...
    tcr_num_layers = trial.suggest_int('tcr_num_layers', 1, 3, step=1)
